...
/*
This Signup code contains NIST recomendations for passwords (8 characters)
*/
...
export default function SignUp() {
    ...
    const onSubmit = data => {
        if (checkIfValid(data.password) === true){
            database.ref('Website3/'+user).set({
                username : username,
                password : password,
    ...
    return (
        ...
        <center><form onSubmit={onSubmit}>
            ...
            <small id="passwordHelp" className="form-text text-muted">Your password must contain 8 characters</small>
            </div>
            <br />
